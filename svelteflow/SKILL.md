---
name: svelteflow
description: Expert guide for building node-based UIs with Svelte Flow (@xyflow/svelte). Use svelteflow when you need to build node-based editors and interactive diagrams
---
...
# references
- [SvelteFlow Learn](https://svelteflow.dev/learn)
- [SvelteFlow Api Reference](https://svelteflow.dev/api-reference)